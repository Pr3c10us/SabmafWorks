...
const Contact = () => {
  ...
  return (
    <main className="relative flex h-full flex-col justify-between bg-white">
      ...
      <section
        id="contact"
        className="relative z-10 flex h-full snap-end flex-col items-center gap-[10vh] bg-white px-6 py-28 md:gap-16  md:px-14 "
      >
          ...
          >
            <div className="mb-4 flex w-full items-center gap-4 ">
              <h1
                ...
                className="text-[5vw] capitalize  text-text md:text-4xl "
              >
                <VowelItalicizer text={"Send us a message"} />
              </h1>
